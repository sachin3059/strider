...
const driverSchema = new mongoose.Schema({
    firstname: {
        type: String,
        required: true,
        minlength: [3, 'first name must be atleast 3 in length']
       
    },

    lastname:{
        type: String,
        minlength: [3, 'last name must be atleast of 3 length']
    },
